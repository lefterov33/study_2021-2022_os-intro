...
![Удаление файла package.json](image/10.png){ #fig:0010 width=70% }

Настрйока каталога курса(git push).
![Настройка каталога](image/11.png){ #fig:0011 width=70% }
